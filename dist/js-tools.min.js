/*!
 * js-tools library
 * Version 1.4.1a built 10/21/2015
 ...
 */
var app={};
(function(d){app._={controllerFactories:{},serviceFactories:{},transformations:[],templateWrappers:{}};app.config=d.extend({baseUrl:"",apiUrl:"api",legacy:!0,bootstrap:3,templates:"jQuery.tmpl",catchExceptions:!0},app.config);d.extend(app,{lastException:null,services:{},init:function(){app.wrapObject(app);var a=d("body");app.services=app.createServices(a);0!=app._.transformations.length&&"[data-controller]"==app._.transformations[app._.transformations.length-1].selector||app.transformation("[data-controller]",function(a){app.createController(a.get(0))});
app.compile(a);d(app).triggerHandler("ready")},wrap:function(a,c){var b=app.config.catchExceptions?function(){try{return a.apply(c,arguments)}catch(b){throw"undefined"==typeof b._stored&&(b._stored=!0,app.lastException=b,d(app).trigger("error",b)),b;}}:function(){return a.apply(c,arguments)};b._wrapped=!0;return b},wrapObject:function(a){for(var c in a)a.hasOwnProperty(c)&&"function"==typeof a[c]&&"undefined"==typeof a[c]._wrapped&&(a[c]=this.wrap(a[c],a));return a},controller:function(a,c){this._.controllerFactories[a]=
c},service:function(a,c){return"undefined"==typeof c?this._.serviceFactories[a]:this._.serviceFactories[a]=c},templateWrapper:function(a,c){if(0==arguments.length)return this._.templateWrappers[app.config.templates];this._.templateWrappers[a]=c},transformation:function(a,c){this._.transformations.push({selector:a,fn:c})},get:function(a){a=d(a);return a.length?a.get(0).controller:null},compile:function(a){d.each(this._.transformations,function(c,b){var e=a.find(b.selector);a.is(b.selector)&&(e=e.add(a));
e.each(function(a,c){var e=b.fn(d(c),app.services);"undefined"!=typeof e&&null!==e&&d(c).replaceWith(e)})});return a},log:function(a){"undefined"!=typeof console&&"undefined"!=typeof console.log&&console.log(a)},createServices:function(a){var c={};d.each(app._.serviceFactories,function(b,d){c[b]=app.wrapObject(d(a,c))});return c},createController:function(a){var c=d(a),b=c.attr("data-controller"),e=app._.controllerFactories[b];if("undefined"!=typeof e)return b=this.createServices(c),a.controller=
app.wrapObject(e(c,b)),a.controller.$=b.$,"function"==typeof a.controller.init&&a.controller.init(),a.controller;throw'Unknown controller: "'+b+'"';},reset:function(){this._.controllerFactories={};this.init();return this}});app.config.legacy&&d.extend(app,{ready:function(a,c){this.log('app.ready() function is deprecated. Use application\'s "ready" event instead.');d(app).on("ready",d.proxy(a,c))}});d(document).ready(function(){app.init()});Object.keys||(Object.keys=function(a){var c=[],b;for(b in a)a.hasOwnProperty(b)&&
c.push(b);return c});d.fn.outerHtml=function(){return d("<div/>").append(this).html()}})(jQuery);(function(){app.service("api",function(d,a){var c=function(a){return function(b,c,d){c=b.responseJSON;$(app).trigger("api.error",[b.status,c,b]);a.triggerError(b.status,c,b)||$(app).trigger("api.error.unhandled",[b.status,c,b])}},b=function(b){return app.config.baseUrl+app.config.apiUrl+(void 0===b?"":"/"+b)},e=function(d,e,f,h){h=h||{};e=e||{};var m=a.deferred();$.ajax(b(d),$.extend({type:f,data:e,success:m.successCallback(),error:c(m)},h));return m},f=function(b,a,c){return e(b,JSON.stringify(a),
c,{contentType:"application/json",dataType:"json"})};return{get:function(b,a){return e(b,a,"GET")},"delete":function(b){return e(b,null,"DELETE")},post:function(b,a){return f(b,a,"post")},put:function(b,a){return f(b,a,"put")},save:function(b,a,c){return a?this.put(b+"/"+a,c):this.post(b,c)},url:function(a){return b(a)}}})})(jQuery,app);(function(d,a){a.service("hash",function(c,b){var e=[],f,g,k=function(){var b=document.location.hash;0==b.indexOf("#")&&(b=b.substr(1));var a="";-1!=b.indexOf("?")&&(a=b.substr(b.indexOf("?")+1),b=b.substr(0,b.indexOf("?")));for(var c=a.split("&"),d={},e=0;e<c.length;e++){var f=c[e].split("=");d[decodeURIComponent(f[0])]=decodeURIComponent(1<f.length?f[1]:"")}c=b.split("/");g={hash:b,path:c,query:d,queryString:a}},l=function(b,a){var d=!1;"string"==typeof b?d=b==g.path[0]:b.test&&(d=b.test(g.hash));
d&&a.apply(c[0].controller,[g].concat(g.path))},h=function(){k();d.each(e,function(b,a){l(a[0],a[1])})};return d.extend(function(){f||(k(),d(window).on("hashchange",h),f=!0);d.each(arguments,function(b,a){var d=a[0],f=a[1];"string"==typeof f&&(f=c[0].controller[f]);e.push([d,f]);l(d,f)})},{EMPTY:/^$/,ALL:/.*/,build:function(b,a){b.constructor==Array&&(b=b.join("/"));var c="#"+b;if(a){var e=[];d.each(a,function(b,a){""==a?e.push(encodeURIComponent(b)):e.push(encodeURIComponent(b)+"="+encodeURIComponent(a))});
